...
func TestBackend_RoundTrip_Timings(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			backend := transport.NewBackend(tt.context, tt.tconf, log, nil, nil)
...
func TestBackend_Compression_Disabled(t *testing.T) {
	...
	backend := transport.NewBackend(hclBody, &transport.Config{}, log, nil, nil)
...
func TestBackend_RoundTrip_Validation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(subT *testing.T) {
			...
			backend := transport.NewBackend(content, &transport.Config{}, log, openapiValidatorOptions, nil)
...
func TestProxy_BufferingOptions(t *testing.T) {
	...
	for i, tc := range []testCase{
		...
		t.Run(tc.name, func(st *testing.T) {
			...
			}), &transport.Config{}, nullLog, newOptions(), nil)
