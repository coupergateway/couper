...
func Test_Scope(t *testing.T) {
	...
	for _, tc := range []testCase{
		...
		{"by scope: permission required by endpoint: insufficient scope", http.MethodPost, "/scope/foo", true, http.StatusForbidden, ``, `access control error: required permission "foo" not granted`, "beta_insufficient_scope"},
		{"by scope: method not permitted", http.MethodDelete, "/scope/foo", true, http.StatusForbidden, ``, "access control error: method DELETE not permitted", "beta_operation_denied"},
		{"by scope: permission required by endpoint via *: insufficient scope", http.MethodGet, "/scope/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_scope"},
		{"by scope: no permission required by endpoint", http.MethodDelete, "/scope/bar", true, http.StatusNoContent, `["a"]`, "", ""},
		{"by scope: required permission by api only: insufficient scope", http.MethodGet, "/scope/permission-from-api", true, http.StatusForbidden, ``, `access control error: required permission "z" not granted`, "beta_insufficient_scope"},
		...
		{"by role: permission required by endpoint: insufficient scope", http.MethodPost, "/role/foo", true, http.StatusForbidden, ``, `access control error: required permission "foo" not granted`, "beta_insufficient_scope"},
		{"by role: method not permitted", http.MethodDelete, "/role/foo", true, http.StatusForbidden, ``, "access control error: method DELETE not permitted", "beta_operation_denied"},
		{"by role: permission required by endpoint via *: insufficient scope", http.MethodGet, "/role/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_scope"},
