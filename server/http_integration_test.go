...
func Test_Scope(t *testing.T) {
	...
	for _, tc := range []testCase{
		...
		{"by scope: additional scope required: insufficient scope", http.MethodPost, "/scope/foo", true, http.StatusForbidden, ``, `access control error: required permission "foo" not granted`, "beta_insufficient_scope"},
		...
		{"by scope: additional scope required by *: insufficient scope", http.MethodGet, "/scope/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_scope"},
		...
		{"by role: additional scope required: insufficient scope", http.MethodPost, "/role/foo", true, http.StatusForbidden, ``, `access control error: required permission "foo" not granted`, "beta_insufficient_scope"},
		...
		{"by role: additional scope required by *: insufficient scope", http.MethodGet, "/role/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_scope"},
