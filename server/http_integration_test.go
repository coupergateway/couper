...
func Test_Scope(t *testing.T) {
	...
	for _, tc := range []testCase{
		...
		{"by scope: permission required by endpoint via *: insufficient permissions", http.MethodGet, "/scope/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_permissions"},
		...
		{"by role: permission required by endpoint via *: insufficient permissions", http.MethodGet, "/role/bar", true, http.StatusForbidden, ``, `access control error: required permission "more" not granted`, "beta_insufficient_permissions"},
