...
* **Fixed**
  * [Endpoint sequences](https://docs.couper.io/configuration/block/endpoint#endpoint-sequence) not being terminated by errors (e.g. `unexpected_status`) ([#648](https://github.com/avenga/couper/pull/648))
