...
* **Fixed**
  ...
  * Fix reloading Couper configuration if Couper was started w/o `-f`, but w/ [`-d` and `-watch`](./docs/CLI.md#global-options) parameters ([#493](https://github.com/avenga/couper/pull/493))
