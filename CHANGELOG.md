...
* **Fixed**
  ...
  * 404 when serving from [`files`](https://docs.couper.io/configuration/block/files) due to wrong registration of `base_path`s ([#803](https://github.com/coupergateway/couper/pull/803))
