...
* **Fixed**
  ...
  * Panic if an [`error_handler` blocks](./docs/REFERENCE.md#error-handler-block) following another [`error_handler` blocks](./docs/REFERENCE.md#error-handler-block) has no label. ([#486](https://github.com/avenga/couper/pull/486))
