...
type ExternalAuthZ struct {
	...
	URL                 string   `hcl:"url,optional" docs:"URL of the authorization service. Relative URL references are resolved against the origin of a referenced or nested {backend} block. Without a path, the AuthZEN access evaluation endpoint {/access/v1/evaluation} is used." default:"/access/v1/evaluation"`
