...
type ServerTLS struct {
	...
	ClientCertificate  []*ClientCertificate `hcl:"client_certificate,block" docs:"Configures a [client certificate](/configuration/block/client_certificate)."`
	ServerCertificates []*ServerCertificate `hcl:"server_certificate,block" docs:"Configures a [server certificate](/configuration/block/server_certificate)."`
}
