...
type Settings struct {
	...
	Storage                   string   `hcl:"storage,optional" docs:"Defines the key/value storage. Currently, can contain a Redis config URL, e.g. \"redis://<user>:<password>@<host>:<port>/<db_number>[?<other-options>]\", or be empty." default:""`
