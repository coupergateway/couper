...
type Settings struct {
	...
	SendServerTimings         bool   `hcl:"send_server_timing_headers,optional" docs:"If enabled, Couper includes an additional [Server-Timing](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Server-Timing) HTTP header field to the client detailing connection and transport relevant metrics for each backend request."`
