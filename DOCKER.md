...
| COUPER_ACCEPT_FORWARDED_URL          | `""`    | List of possible values `host,proto,port` which changes the related client request variables. Therefore affects a relative SAML [sp_acs_url](https://github.com/avenga/couper/blob/master/docs/REFERENCE.md#saml-block) attribute too. |
