...
| `beta_roles_map` |map|-| mapping of roles to granted permissions | Non-mapped roles can be assigned with `*` to specific claims. |`beta_roles_map = { role1 = ["p1", "p2"], role2 = ["p3"], "*" = ["public"] }`|
